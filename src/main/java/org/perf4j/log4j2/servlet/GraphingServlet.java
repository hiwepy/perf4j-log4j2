 ...
 * the License.
 */
package org.perf4j.log4j2.servlet;


import org.perf4j.chart.StatisticsChartGenerator;
import org.perf4j.log4j2.GraphingStatisticsAppender;
 ...
 * have been created by the log4j2 framework. Thus, in order to add live performance graphs to a web application, you
 * should first create the necessary GraphingStatisticsAppenders in your log4j2.xml config file. Then, you should create
...
public class GraphingServlet extends AbstractGraphingServlet {
     ...
     * {@link org.perf4j.log4j2.GraphingStatisticsAppender#getAppenderByName(String)} method to find the appender with
     * the specified name.
     *
