...
import org.apache.logging.log4j.core.layout.CSVFormat;
...
/* public static StatisticsCsvLayout createDefaultLayout() {
        return new StatisticsCsvLayout(null, Charset.forName(DEFAULT_CHARSET), CSVFormat.valueOf(DEFAULT_FORMAT), null, null);
    }

    public static <CSVFormat> StatisticsCsvLayout createLayout(final CSVFormat format) {
